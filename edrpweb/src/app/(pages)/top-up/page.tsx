...
const TopUpPage = () => {
  ...
  return (
    <div className="h-[463px] flex items-center justify-center mb-[100px] xl:mt-[0px] lg:mt-[-800px] sm:mt-[-600px] mt-[-200px] px-4">
      <div className="w-full max-w-md">
        <div className="flex items-center justify-center gap-4 pb-[36px]">
          <h1 className="text-[24px] font-extrabold text-center">
            TOP UP Your Account
          </h1>
          <p className="text-[18px] font-extrabold bg-[#FF0040] rounded-[6px] px-[8px] py-[6px]">
            2x
          </p>
        </div>
        <form>
          ...
          <div className="mb-4">
            <div
              className={`relative flex items-center bg-[#0D0D0D] rounded-[4px] transition-all ${
                emailError
          ...
          <div className="pb-[36px] flex items-center">
            ...
            <label
              htmlFor="terms"
              className="pl-2 text-[14px] font-semibold leading-snug text-[#C2C2C2]"
            >
