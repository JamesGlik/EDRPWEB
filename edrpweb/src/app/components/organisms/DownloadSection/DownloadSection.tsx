...
const DownloadSection = () => {
  return (
    <div className='py-[194px] lg:px-[160px] px-4'>
        <div className='flex flex-row justify-between gap-[88px]'>
            <div className=''>
                ...
                <div className='flex flex-row bg-[#0D0D0D] border border-[#373737] rounded-[12px] py-[20px] px-[20px] items-center xl:w-[774px]'>
                    <Image
                        src={Gta5Logo}
                        width={45}
                        height={45}
                    ...
                    <button className='font-extrabold bg-[#FF0040] px-[50px] py-[18px] rounded-[6px] ml-auto cursor-pointer transition-colors duration-300 hover:bg-[#313131]'>PURCHASE</button>
                </div>
                <div className='flex flex-row bg-[#0D0D0D] border border-[#373737] rounded-[12px] py-[20px] px-[20px] items-center mt-[24px]'>
                    ...
                    <button className='font-extrabold bg-[#FF0040] px-[50px] py-[18px] rounded-[6px] ml-auto cursor-pointer transition-colors duration-300 hover:bg-[#313131]'>DOWNLOAD</button>
                </div>
            </div>
